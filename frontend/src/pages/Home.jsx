...
const Home = () => {
  ...
  const handleLogout = async () => {
    try {
      await axios.get(
        "https://movieapp-pj8n.onrender.com/api/auth/logout",
        {},
  ...
  const fetchTmdbMovies = async () => {
    const res = await axios.get("https://movieapp-pj8n.onrender.com/api/movies", {
      params: {
        page,
        search,
        minRating
  ...
  const fetchAdminMovies = async () => {
    const res = await axios.get(
      "https://movieapp-pj8n.onrender.com/api/movies/admin-public"
    )
